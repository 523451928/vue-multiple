<template>
  <div class="my-loadmore">
    <div class="loadmore-content" :class="{'is-dropped':topDropped || bottomDropped}"
      ...
      <slot></slot>
      <div class="weui-loadmore" v-show="!allBottomLoaded && isAutoLoadmore">
      ...
      <slot name="nomore"  v-if="allBottomLoaded">
        <div class="no-more">
    ...
    methods: {
      init(){
        ...
        if (this.isAutoLoadmore) {
          let throttleFn = throttle(this.checkBottomReached, 1200)
